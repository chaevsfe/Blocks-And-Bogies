...
public abstract class TripleAxleExtendedShortDisplay extends BlocksBogiesBogieDisplay {
    public static class TripleAxleLargeExtendedShort extends TripleAxleExtendedShortDisplay {
        ...
        public TripleAxleLargeExtendedShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6SE_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_6SE_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_6SE_L_C_ROD);
    ...
    public static class TripleAxleExtraLargeExtendedShort extends TripleAxleExtendedShortDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public TripleAxleExtraLargeExtendedShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6SE_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6LEW_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6SE_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6SE_L_C_ROD);
