...
public abstract class DoubleAxleExtraLongDisplay extends BlocksBogiesBogieDisplay {
    public static class DoubleAxleLargeExtraLong extends DoubleAxleExtraLongDisplay {
        ...
        public DoubleAxleLargeExtraLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_4LE_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_4LE_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_4LE_L_C_ROD);
    ...
    public static class DoubleAxleExtraLargeExtraLong extends DoubleAxleExtraLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public DoubleAxleExtraLargeExtraLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_4LE_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_4P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_4LE_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_4LE_L_C_ROD);
