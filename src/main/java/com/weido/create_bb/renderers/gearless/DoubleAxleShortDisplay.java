...
public abstract class DoubleAxleShortDisplay extends BlocksBogiesBogieDisplay {
    public static class DoubleAxleLargeShort extends DoubleAxleShortDisplay {
        ...
        public DoubleAxleLargeShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_4S_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_4S_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_4S_L_C_ROD);
    ...
    public static class DoubleAxleExtraLargeShort extends DoubleAxleShortDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public DoubleAxleExtraLargeShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_4S_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_4P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_4S_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_4S_L_C_ROD);
