...
public abstract class SextupleAxleLongDisplay extends BlocksBogiesBogieDisplay {
    public static class SextupleAxleLargeLong extends SextupleAxleLongDisplay {
        ...
        public SextupleAxleLargeLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_12L_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_12L_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_12L_L_C_ROD);
