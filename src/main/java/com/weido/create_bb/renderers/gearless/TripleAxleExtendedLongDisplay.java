...
public abstract class TripleAxleExtendedLongDisplay extends BlocksBogiesBogieDisplay {
    public static class TripleAxleLargeExtendedLong extends TripleAxleExtendedLongDisplay {
        ...
        public TripleAxleLargeExtendedLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6LE_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_6LE_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_6LE_L_C_ROD);
    ...
    public static class TripleAxleExtraLargeExtendedLong extends TripleAxleExtendedLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public TripleAxleExtraLargeExtendedLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6LE_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6LEW_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6LE_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6LE_L_C_ROD);
