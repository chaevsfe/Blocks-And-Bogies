...
public abstract class QuadrupleAxleShortDisplay extends BlocksBogiesBogieDisplay {
    public static class QuadrupleAxleLargeShort extends QuadrupleAxleShortDisplay {
        ...
        public QuadrupleAxleLargeShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_8S_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_8S_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_8S_L_C_ROD);
    ...
    public static class QuadrupleAxleExtraLargeShort extends QuadrupleAxleShortDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public QuadrupleAxleExtraLargeShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_8S_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_8P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_8S_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_8S_L_C_ROD);
