...
public abstract class DoubleAxleLongDisplay extends BlocksBogiesBogieDisplay {
    public static class DoubleAxleLargeLong extends DoubleAxleLongDisplay {
        ...
        public DoubleAxleLargeLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_4L_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_4L_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_4L_L_C_ROD);
    ...
    public static class DoubleAxleExtraLargeLong extends DoubleAxleLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public DoubleAxleExtraLargeLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_4L_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_4P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_4L_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_4L_L_C_ROD);
