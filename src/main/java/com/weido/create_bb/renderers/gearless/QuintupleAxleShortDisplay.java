...
public abstract class QuintupleAxleShortDisplay extends BlocksBogiesBogieDisplay {
    public static class QuintupleAxleLargeShort extends QuintupleAxleShortDisplay {
        ...
        public QuintupleAxleLargeShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_10S_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_10S_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_10S_L_C_ROD);
    ...
    public static class QuintupleAxleExtraLargeShort extends QuintupleAxleShortDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public QuintupleAxleExtraLargeShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_10S_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_10P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10S_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10S_L_C_ROD);
