...
public abstract class TripleAxleLongDisplay extends BlocksBogiesBogieDisplay {
    public static class TripleAxleLargeLong extends TripleAxleLongDisplay {
        ...
        public TripleAxleLargeLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6L_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_6L_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_6L_L_C_ROD);
    ...
    public static class TripleAxleExtraLargeLong extends TripleAxleLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public TripleAxleExtraLargeLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6L_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6L_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6L_L_C_ROD);
