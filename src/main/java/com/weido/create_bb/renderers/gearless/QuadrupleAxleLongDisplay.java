...
public abstract class QuadrupleAxleLongDisplay extends BlocksBogiesBogieDisplay {
    public static class QuadrupleAxleLargeLong extends QuadrupleAxleLongDisplay {
        ...
        public QuadrupleAxleLargeLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_8L_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_8L_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_8L_L_C_ROD);
    ...
    public static class QuadrupleAxleExtraLargeLong extends QuadrupleAxleLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public QuadrupleAxleExtraLargeLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_8L_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_8P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_8L_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_8L_L_C_ROD);
