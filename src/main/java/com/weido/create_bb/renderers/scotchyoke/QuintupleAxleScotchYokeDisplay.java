...
public abstract class QuintupleAxleScotchYokeDisplay implements BogeyDisplay {
    public static class QuintupleAxleLargeScotchYoke extends QuintupleAxleScotchYokeDisplay {
        ...
        public QuintupleAxleLargeScotchYoke(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_10C_FRAME);
            ...
            r_pin = prov.create(BogiePartials.LARGE_10C_R_PIN);
            l_pin = prov.create(BogiePartials.LARGE_10C_L_PIN);
            r_slider = prov.create(BogiePartials.LARGE_10C_R_SLIDER);
            l_slider = prov.create(BogiePartials.LARGE_10C_L_SLIDER);
    ...
    public static class QuintupleAxleExtraLargeScotchYoke extends QuintupleAxleScotchYokeDisplay {
        private final Affine<?> frame;
        private final Affine<?> belt;
        private final ScrollHandle beltScroll;
        private final Affine<?> r_pin;
        ...
        public QuintupleAxleExtraLargeScotchYoke(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_10C_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_10P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_pin = prov.create(BogiePartials.EXTRA_LARGE_10C_R_PIN);
            l_pin = prov.create(BogiePartials.EXTRA_LARGE_10C_L_PIN);
            r_slider = prov.create(BogiePartials.EXTRA_LARGE_10C_R_SLIDER);
            l_slider = prov.create(BogiePartials.EXTRA_LARGE_10C_L_SLIDER);
