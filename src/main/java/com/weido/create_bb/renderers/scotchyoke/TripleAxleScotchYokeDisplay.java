...
public abstract class TripleAxleScotchYokeDisplay implements BogeyDisplay {
    public static class TripleAxleLargeScotchYoke extends TripleAxleScotchYokeDisplay {
        ...
        public TripleAxleLargeScotchYoke(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6C_FRAME);
            ...
            r_pin = prov.create(BogiePartials.LARGE_6C_R_PIN);
            l_pin = prov.create(BogiePartials.LARGE_6C_L_PIN);
            r_slider = prov.create(BogiePartials.LARGE_6C_R_SLIDER);
            l_slider = prov.create(BogiePartials.LARGE_6C_L_SLIDER);
    ...
    public static class TripleAxleExtraLargeScotchYoke extends TripleAxleScotchYokeDisplay {
        private final Affine<?> frame;
        private final Affine<?> belt;
        private final ScrollHandle beltScroll;
        private final Affine<?> r_pin;
        ...
        public TripleAxleExtraLargeScotchYoke(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6C_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_pin = prov.create(BogiePartials.EXTRA_LARGE_6C_R_PIN);
            l_pin = prov.create(BogiePartials.EXTRA_LARGE_6C_L_PIN);
            r_slider = prov.create(BogiePartials.EXTRA_LARGE_6C_R_SLIDER);
            l_slider = prov.create(BogiePartials.EXTRA_LARGE_6C_L_SLIDER);
