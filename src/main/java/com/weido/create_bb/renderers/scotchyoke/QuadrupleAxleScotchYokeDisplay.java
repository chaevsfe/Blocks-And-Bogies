...
public abstract class QuadrupleAxleScotchYokeDisplay implements BogeyDisplay {
    public static class QuadrupleAxleLargeScotchYoke extends QuadrupleAxleScotchYokeDisplay {
        ...
        public QuadrupleAxleLargeScotchYoke(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_8C_FRAME);
            ...
            r_pin = prov.create(BogiePartials.LARGE_8C_R_PIN);
            l_pin = prov.create(BogiePartials.LARGE_8C_L_PIN);
            r_slider = prov.create(BogiePartials.LARGE_8C_R_SLIDER);
            l_slider = prov.create(BogiePartials.LARGE_8C_L_SLIDER);
    ...
    public static class QuadrupleAxleExtraLargeScotchYoke extends QuadrupleAxleScotchYokeDisplay {
        private final Affine<?> frame;
        private final Affine<?> belt;
        private final ScrollHandle beltScroll;
        private final Affine<?> r_pin;
        ...
        public QuadrupleAxleExtraLargeScotchYoke(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_8C_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_8P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_pin = prov.create(BogiePartials.EXTRA_LARGE_8C_R_PIN);
            l_pin = prov.create(BogiePartials.EXTRA_LARGE_8C_L_PIN);
            r_slider = prov.create(BogiePartials.EXTRA_LARGE_8C_R_SLIDER);
            l_slider = prov.create(BogiePartials.EXTRA_LARGE_8C_L_SLIDER);
