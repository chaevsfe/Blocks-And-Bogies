...
public abstract class TripleAxleWalschaertsLongDisplay extends BlocksBogiesBogieDisplay {
    public static class TripleAxleLargeWalschaertsLong extends TripleAxleWalschaertsLongDisplay {
        ...
        public TripleAxleLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6LW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_6LW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_6LW_L_C_ROD);
    ...
    public static class TripleAxleExtraLargeWalschaertsLong extends TripleAxleWalschaertsLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public TripleAxleExtraLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6LW_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_L_C_ROD);
