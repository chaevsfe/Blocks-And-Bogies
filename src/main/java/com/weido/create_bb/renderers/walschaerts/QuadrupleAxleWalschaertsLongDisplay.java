...
public abstract class QuadrupleAxleWalschaertsLongDisplay extends BlocksBogiesBogieDisplay {
    public static class QuadrupleAxleLargeWalschaertsLong extends QuadrupleAxleWalschaertsLongDisplay {
        ...
        public QuadrupleAxleLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_8LW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_8LW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_8LW_L_C_ROD);
            r_m_rod = prov.create(BogiePartials.LARGE_8LW_R_M_ROD);
            l_m_rod = prov.create(BogiePartials.LARGE_8LW_L_M_ROD);
            r_p_rod = prov.create(BogiePartials.LARGE_R_P_ROD_WALSCHAERTS);
            l_p_rod = prov.create(BogiePartials.LARGE_L_P_ROD_WALSCHAERTS);
            r_r_rod = prov.create(BogiePartials.LARGE_8LW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.LARGE_8LW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.LARGE_8LW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.LARGE_8LW_L_E_ROD);
        ...
        public void update(boolean forwards, float wheelAngle) {
            ...
            e_crank.translate(0, 1, forwards ? LARGE_8L_OFFSET : -LARGE_8L_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle);
    ...
    public static class QuadrupleAxleExtraLargeWalschaertsLong extends QuadrupleAxleWalschaertsLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public QuadrupleAxleExtraLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_8LW_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_8P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_L_C_ROD);
            r_m_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_R_M_ROD);
            l_m_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_L_M_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.EXTRA_LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.EXTRA_LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.EXTRA_LARGE_8LW_L_E_ROD);
        ...
        public void update(boolean forwards, float wheelAngle) {
            ...
            e_crank.translate(0, 1.25f, forwards ? EXTRA_LARGE_8L_OFFSET : -EXTRA_LARGE_8L_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle);
