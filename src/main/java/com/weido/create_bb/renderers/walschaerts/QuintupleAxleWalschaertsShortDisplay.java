...
public abstract class QuintupleAxleWalschaertsShortDisplay extends BlocksBogiesBogieDisplay {
    public static class QuintupleAxleLargeWalschaertsShort extends QuintupleAxleWalschaertsShortDisplay {
        ...
        public QuintupleAxleLargeWalschaertsShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_10SW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_10SW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_10SW_L_C_ROD);
            r_m_rod = prov.create(BogiePartials.LARGE_10SW_R_M_ROD);
            l_m_rod = prov.create(BogiePartials.LARGE_10SW_L_M_ROD);
            r_p_rod = prov.create(BogiePartials.LARGE_R_P_ROD_WALSCHAERTS);
            l_p_rod = prov.create(BogiePartials.LARGE_L_P_ROD_WALSCHAERTS);
            r_r_rod = prov.create(BogiePartials.LARGE_10SW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.LARGE_10SW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.LARGE_10SW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.LARGE_10SW_L_E_ROD);
    ...
    public static class QuintupleAxleExtraLargeWalschaertsShort extends QuintupleAxleWalschaertsShortDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public QuintupleAxleExtraLargeWalschaertsShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_10SW_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_10P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_L_C_ROD);
            r_m_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_R_M_ROD);
            l_m_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_L_M_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.EXTRA_LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.EXTRA_LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.EXTRA_LARGE_10SW_L_E_ROD);
