...
public abstract class SingleAxleWalschaertsLongDisplay extends BlocksBogiesBogieDisplay {
    public static class SingleAxleLargeWalschaertsLong extends SingleAxleWalschaertsLongDisplay {
        ...
        public SingleAxleLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_2LW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_2LW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_2LW_L_C_ROD);
    ...
    public static class SingleAxleExtraLargeWalschaertsLong extends SingleAxleWalschaertsLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public SingleAxleExtraLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_2LW_FRAME);
