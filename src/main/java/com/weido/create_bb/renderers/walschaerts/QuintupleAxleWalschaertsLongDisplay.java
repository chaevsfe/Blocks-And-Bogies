...
public abstract class QuintupleAxleWalschaertsLongDisplay extends BlocksBogiesBogieDisplay {
    public static class QuintupleAxleLargeWalschaertsLong extends QuintupleAxleWalschaertsLongDisplay {
        ...
        public QuintupleAxleLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_10LW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_10LW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_10LW_L_C_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.LARGE_10LW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.LARGE_10LW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.LARGE_10LW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.LARGE_10LW_L_E_ROD);
    ...
    public static class QuintupleAxleExtraLargeWalschaertsLong extends QuintupleAxleWalschaertsLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public QuintupleAxleExtraLargeWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_10LW_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_10P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10LW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10LW_L_C_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.EXTRA_LARGE_10LW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.EXTRA_LARGE_10LW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.EXTRA_LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.EXTRA_LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.EXTRA_LARGE_10LW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.EXTRA_LARGE_10LW_L_E_ROD);
