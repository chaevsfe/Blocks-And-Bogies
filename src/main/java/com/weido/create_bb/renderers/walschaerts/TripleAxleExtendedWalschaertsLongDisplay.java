...
public abstract class TripleAxleExtendedWalschaertsLongDisplay extends BlocksBogiesBogieDisplay {
    public static class TripleAxleLargeExtendedWalschaertsLong extends TripleAxleExtendedWalschaertsLongDisplay {
        ...
        public TripleAxleLargeExtendedWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6LEW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_6LEW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_6LEW_L_C_ROD);
            r_m_rod = prov.create(BogiePartials.LARGE_6LW_R_M_ROD);
            l_m_rod = prov.create(BogiePartials.LARGE_6LW_L_M_ROD);
            r_p_rod = prov.create(BogiePartials.LARGE_R_P_ROD_WALSCHAERTS);
            l_p_rod = prov.create(BogiePartials.LARGE_L_P_ROD_WALSCHAERTS);
            r_r_rod = prov.create(BogiePartials.LARGE_6LW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.LARGE_6LW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.LARGE_6LW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.LARGE_6LW_L_E_ROD);
        ...
        public void update(boolean forwards, float wheelAngle) {
            ...
            shafts[6].translate(-.5f, .25f, (forwards ? 1.75f : -1.75f)-.5f)
                    .center()
                    .rotateTo(Direction.UP, Direction.SOUTH)
                    .rotateYDegrees(wheelAngle)
                    .uncenter();
    ...
    public static class TripleAxleExtraLargeExtendedWalschaertsLong extends TripleAxleExtendedWalschaertsLongDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public TripleAxleExtraLargeExtendedWalschaertsLong(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6LEW_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6LEW_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6LEW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6LEW_L_C_ROD);
            r_m_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_R_M_ROD);
            l_m_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_L_M_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.EXTRA_LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.EXTRA_LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.EXTRA_LARGE_6LW_L_E_ROD);
