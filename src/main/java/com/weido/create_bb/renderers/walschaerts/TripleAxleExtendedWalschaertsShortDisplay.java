...
public abstract class TripleAxleExtendedWalschaertsShortDisplay extends BlocksBogiesBogieDisplay {
    public static class TripleAxleLargeExtendedWalschaertsShort extends TripleAxleExtendedWalschaertsShortDisplay {
        ...
        public TripleAxleLargeExtendedWalschaertsShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6SEW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_6SEW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_6SEW_L_C_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.LARGE_6SW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.LARGE_6SW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.LARGE_6SW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.LARGE_6SW_L_E_ROD);
    ...
    public static class TripleAxleExtraLargeExtendedWalschaertsShort extends TripleAxleExtendedWalschaertsShortDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public TripleAxleExtraLargeExtendedWalschaertsShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6SEW_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6LEW_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6SEW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6SEW_L_C_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.EXTRA_LARGE_6SW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.EXTRA_LARGE_6SW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.EXTRA_LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.EXTRA_LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.EXTRA_LARGE_6SW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.EXTRA_LARGE_6SW_L_E_ROD);
