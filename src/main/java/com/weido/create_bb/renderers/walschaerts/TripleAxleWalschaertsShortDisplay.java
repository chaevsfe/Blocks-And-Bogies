...
public abstract class TripleAxleWalschaertsShortDisplay extends BlocksBogiesBogieDisplay {
    public static class TripleAxleLargeWalschaertsShort extends TripleAxleWalschaertsShortDisplay {
        ...
        public TripleAxleLargeWalschaertsShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_6SW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_6SW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_6SW_L_C_ROD);
    ...
    public static class TripleAxleExtraLargeWalschaertsShort extends TripleAxleWalschaertsShortDisplay {
        private static final RodCalculations.WalschaertsParameters PARAMS = new RodCalculations.WalschaertsParameters(
        ...
        public TripleAxleExtraLargeWalschaertsShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.EXTRA_LARGE_6SW_FRAME);
            var scrolling = prov.createScrolling(BogiePartials.EXTRA_LARGE_6P_BELTS, AllSpriteShifts.BOGEY_BELT);
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6SW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_6SW_L_C_ROD);
