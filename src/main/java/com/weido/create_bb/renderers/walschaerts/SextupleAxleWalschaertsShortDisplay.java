...
public abstract class SextupleAxleWalschaertsShortDisplay extends BlocksBogiesBogieDisplay {
    public static class SextupleAxleLargeWalschaertsShort extends SextupleAxleWalschaertsShortDisplay {
        ...
        public SextupleAxleLargeWalschaertsShort(ElementProvider<?> prov) {
            frame = prov.create(BogiePartials.LARGE_12SW_FRAME);
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_12SW_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_12SW_L_C_ROD);
            ...
            r_r_rod = prov.create(BogiePartials.LARGE_12SW_R_R_ROD);
            l_r_rod = prov.create(BogiePartials.LARGE_12SW_L_R_ROD);
            r_e_link = prov.create(BogiePartials.LARGE_R_E_LINK);
            l_e_link = prov.create(BogiePartials.LARGE_L_E_LINK);
            r_e_rod = prov.create(BogiePartials.LARGE_12SW_R_E_ROD);
            l_e_rod = prov.create(BogiePartials.LARGE_12SW_L_E_ROD);
        ...
        public void update(boolean forwards, float wheelAngle) {
            ...
            e_crank.translate(0, 1, forwards ? LARGE_12S_OFFSET : -LARGE_12S_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle);
