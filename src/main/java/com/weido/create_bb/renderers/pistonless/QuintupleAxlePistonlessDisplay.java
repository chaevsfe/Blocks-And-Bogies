...
public abstract class QuintupleAxlePistonlessDisplay implements BogeyDisplay {
    public static class QuintupleAxleLargePistonless extends QuintupleAxlePistonlessDisplay {
        ...
        public QuintupleAxleLargePistonless(ElementProvider<?> prov) {
            ...
            r_c_rod = prov.create(BogiePartials.LARGE_10P_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.LARGE_10P_L_C_ROD);
    ...
    public static class QuintupleAxleExtraLargePistonless extends QuintupleAxlePistonlessDisplay {
        private final Affine<?> frame;
        private final Affine<?> belt;
        private final ScrollHandle beltScroll;
        private final Affine<?> r_c_rod;
        ...
        public QuintupleAxleExtraLargePistonless(ElementProvider<?> prov) {
            ...
            belt = scrolling.getFirst();
            beltScroll = scrolling.getSecond();
            r_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10P_R_C_ROD);
            l_c_rod = prov.create(BogiePartials.EXTRA_LARGE_10P_L_C_ROD);
