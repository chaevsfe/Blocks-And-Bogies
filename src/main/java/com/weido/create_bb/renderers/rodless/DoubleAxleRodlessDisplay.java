...
public abstract class DoubleAxleRodlessDisplay implements BogeyDisplay {
    public static class DoubleAxleLargeRodless extends DoubleAxleRodlessDisplay {
        ...
        public DoubleAxleLargeRodless(ElementProvider<?> prov) {
    ...
    public static class DoubleAxleExtraLargeRodless extends DoubleAxleRodlessDisplay {
        private final Affine<?> frame;
        private final Affine<?> belt;
        private final ScrollHandle beltScroll;
        private final Affine<?>[] wheels;
        ...
        public DoubleAxleExtraLargeRodless(ElementProvider<?> prov) {
